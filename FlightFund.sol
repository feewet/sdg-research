...
/**
 * @notice Smart Contract draft for EthDenver 2019
 * @author Hal Hyatt
 * @dev This code has not been tested, but should compile
 *
 * I wrote this early on when learning smart contracts, but thought
 * it would be a good example of how I organize my code. If I have time
 * at some point, I might return and complete this project.
 *
 * FlightFund allows the submission of document hashes which can be validated
 * or refuted by a set of validators.
 */
contract FlightFund {
